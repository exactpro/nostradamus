		...
		return (
			<div className={cn("main-statistic", this.props.className)}>
				<div className="main-statistic__block">
					<div className="main-statistic__number main-statistic__number_type_total">
				...
				<div className="main-statistic__block">
					<div className="main-statistic__number main-statistic__number_type_filtered">
						{this.props.statistic.filtered}
					</div>
