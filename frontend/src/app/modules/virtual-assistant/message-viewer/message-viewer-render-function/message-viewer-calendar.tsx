...
export default function MessageViewerCalendar(props: MessageViewerCalendarProps){
    ...
    const sendCalendarDate = () => {
        ...
        let [startDate, endDate] = calendarValue;
        let dateSendMessage: string = JSON.stringify(calendarValue); 
    ...
    useEffect(() => {
        ...
        let prevButton = calendarRef.current.getElementsByClassName("react-calendar__navigation__prev-button");
        let nextButton = calendarRef.current.getElementsByClassName("react-calendar__navigation__next-button");
    ...
    return (
        <div className={cn("message-viewer-calendar",
            ...
            <p className="message-viewer-calendar__title">{props.calendarTitle}</p>
            ...
            <Button text="Send Date"
                    ...
                    type="submit"
                    className={cn("message-viewer-widget-buttons__send", "message-viewer-widget-buttons__send_shifted")}/>
            </div>
