...
export default function(props: Props)
{
  ...
  let getActiveSlide = (i: number): boolean =>{
    let index: number = props.indexOfActiveSlide < props.slides.length -1? props.indexOfActiveSlide : -1;
    return index === i
  }

  let animation = "carousel" + (props.transparency && props.slides.length>3 ? "-transparent": "")
  let slides = [props.slides[props.slides.length-1], ...props.slides.slice(0,props.slides.length-1)]
